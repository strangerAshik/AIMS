...
<p class="text-center">
    <button class="btn btn-primary btn-block" data-toggle="modal" data-target="#atcWatchHandover">Watch Handover</button>
	
</p>
<p class="text-center">
    <button class="btn btn-primary btn-block" data-toggle="modal" data-target="#atcObservation">Observation</button>
	
</p>
<p class="text-center">
    <button class="btn btn-primary btn-block" data-toggle="modal" data-target="#atcAircraftMovement">Add Aircraft Movement</button>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
							 <div class="box-header">
									<h3 class="box-title">ATC Log Details</h3>
							  </div>
                <!-- /.box-header -->
...
@yield('atcObservation') 
@yield('atcWatchHandover') 
@yield('atcAircraftMovement') 
