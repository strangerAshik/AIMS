...
<?php $imTeamMember=CommonFunction::isItMe($members,Auth::user()->emp_id());?>
<?php $role=Auth::user()->Role();?>
@if($imTeamMember=='true'|| $role=='DB Admin' || $role=='Chief Admin')
...
<div class="row" id="ProgramDetails">
			...
			<tr>
			 ...
			 @endif
			   <tr><th class="col-md-3" >SIA / Tracking Number</th><td>{{$info->sia_number}}</td></tr>
			   <tr><th>Organization Name</th><td>{{$info->org_name}}</td></tr>
			   <tr><th>Event On</th><td>{{$info->event}}</td></tr>
			    <tr><th>Specific Purpose</th><td>{{nl2br($info->specific_purpose)}}</td></tr>
			   <tr><th>Start Date</th><td>{{$info->date}}</td></tr>
			   <tr><th>End Date</th><td>{{$info->end_date}}</td></tr>
			   ...
			   <tr><th>Remarks</th><td>{{nl2br($info->remarks)}}</td></tr>
                ...
                <!-- /.box-header -->
					...
					<tr>
					 ...
					 @endif
					   ...
					   <tr><th class="col-md-3">Objective</th><td>{{$info->objective}}</td></tr>
					   ...
					   <tr><th>SIA By Critical Element</th><td>
				...
				@endif
					...
					<tr>
					 ...
					 @endif
					   ...
					   <tr><th class="col-md-3">Hazard Identification</th><td>{{$info->hazard_identification}}</td></tr>
					   ...
					   <tr><th>Final Risk Statement</th><td>{{$info->risk_statement}}</td></tr>
...
<div class="row" id="Findings">
                    ...
                    <tr><th>No.</th><th>Finding No.</th><th>Title</th><th>Target Date</th><th>Mitigate?</th><th class='hidden-print'>Details</th></tr>
                    </thead>
				     <tbody>					   
...
<div class="row" id="SafetyConcern">
                ...
                <!-- /.box-header -->
                    ...
                    <table class="table table-bordered">
					<thead>
						<tr><th>No.</th><th>Finding Number</th><th>SC Number</th><th>Title</th><th>Target Date</th><th>Approved</th><th class='hidden-print'>Details</th></tr>
					</thead>
...
<div class="row" id="EDP">
                ...
                <!-- /.box-header -->
                    ...
                    <tbody>					   
						...
						<tr><th>No.</th><th>EDP Number</th><th>Title</th><th>Findign Number</th><th>SC Number</th><th>Legal Openion</th><th>Approval</th><th class='hidden-print'>Details</th></tr>
						@if($edps)
						...
						<td class='hidden-print'><a href="{{URL::to('edp/singleEdp/'.$info->edp_number)}}">Details</a></td></tr>
						@endforeach
						@else 
						<tr><td colspan="4">
							No EDP Found Yet!!						
...
<div class="row" id="ApprovalInfo">
                ...
                <!-- /.box-header -->
					...
					{{$num=0}}
						 ...
						 <table class="table table-bordered">
                  			 <tbody>		
							 	<tr><th>Approved By</th><th>Designation</th><th>Approval Date</th><th>Note</th><th class='hidden-print'>Edit</th><th class='hidden-print' >S.D</th><th class='hidden-print'>P.D</th></tr>
					...
					<tr>
					<td class="col-md-3">{{$info->approved_by}}</td><td>{{$info->designation}}</td><td>{{$info->approval_date}}</td><td>{{$info->approval_note}}</td>
