...
<section class='content widthController'>
  <!-- Chat box -->
                            <div class="box box-success">
                                      ...
                                      {{HTML::Image('files/userPhoto/'.$image,'User image',array('class'=>'online'))}}  
                                        ...
                                        <div class="attachment">
                                            ...
                                            <div class="pull-right">
                                               	{{HTML::link('files/sc_follow_up_file/'.$followUp->follow_up_file,'Open',array('target'=>'_blank','class'=>'btn btn-primary btn-sm btn-flat'))}}
                                            </div>
                                        </div><!-- /.attachment -->
										@endif
                                    </div><!-- /.item -->
								...
								{{Form::open(array('url' => 'safety/saveFollowUp', 'method' => 'post',  'class'=>'form-horizontal','data-toggle'=>'validator', 'role'=>'form','files'=>true))}}
									{{ Form::hidden('sc_num',$sc_num) }}
